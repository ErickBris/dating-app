...
// Firebase settings | For sending FCM (Firebase Cloud Messages) | http://ifsoft.co.uk/help/how_to_migrate_from_gcm_to_fcm/

$B['GOOGLE_API_KEY'] = "AIzaSyCVK3d_GOOGLE_API_KEY"; 		// GOOGLE_API_KEY = Firebase Server key
$B['GOOGLE_SENDER_ID'] = "3424234234234";					// GOOGLE_SENDER_ID = Firebase Sender Id
